...
const wppURI = "https://wa.me/" + phoneNumber + "?text=";
...
function selectMealItem(optionMealSelected) {
  ...
  mealPrice = Number(
    optionMealSelected
      .querySelector(".option-price span")
      .innerHTML.replace(",", ".")
  );
  isItReady();
}
function selectDrinkItem(optionDrinkSelected) {
  ...
  drinkName = optionDrinkSelected.querySelector(
    ".option-name strong"
  ).innerHTML;
  drinkPrice = Number(
    optionDrinkSelected
...
function selectDessertItem(optionDessertSelected) {
  ...
  dessertName = optionDessertSelected.querySelector(
    ".option-name strong"
  ).innerHTML;
  dessertPrice = Number(
    optionDessertSelected
      .querySelector(".option-price span")
      .innerHTML.replace(",", ".")
  );
  isItReady();
...
function sendMessage(total) {
  ...
  let URI = wppURI + encodeURIComponent(message);
  window.open(URI);
}
function reviewText() {
